...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: "#", label: "Laboratory", icon: FlaskConical, soon: true },
  { href: "#", label: "Radiology", icon: Scan, soon: true },
  { href: "#", label: "Procedures", icon: ClipboardList, soon: true },
  { href: "#", label: "Insurance", icon: ShieldCheck, soon: true },
  { href: "#", label: "Inventory", icon: Package, soon: true },
